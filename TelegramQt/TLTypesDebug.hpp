...
QDebug operator<<(QDebug d, const TLAccountSentEmailCode &accountSentEmailCodeValue);
QDebug operator<<(QDebug d, const TLAccountTakeout &accountTakeoutValue);
...
QDebug operator<<(QDebug d, const TLChatOnlines &chatOnlinesValue);
...
QDebug operator<<(QDebug d, const TLFileHash &fileHashValue);
...
QDebug operator<<(QDebug d, const TLHelpPassportConfig &helpPassportConfigValue);
QDebug operator<<(QDebug d, const TLHelpSupportName &helpSupportNameValue);
...
QDebug operator<<(QDebug d, const TLInputCheckPasswordSRP &inputCheckPasswordSRPValue);
QDebug operator<<(QDebug d, const TLInputClientProxy &inputClientProxyValue);
...
QDebug operator<<(QDebug d, const TLInputMessage &inputMessageValue);
...
QDebug operator<<(QDebug d, const TLInputSecureFile &inputSecureFileValue);
...
QDebug operator<<(QDebug d, const TLPageRelatedArticle &pageRelatedArticleValue);
QDebug operator<<(QDebug d, const TLPasswordKdfAlgo &passwordKdfAlgoValue);
...
QDebug operator<<(QDebug d, const TLPollAnswer &pollAnswerValue);
...
QDebug operator<<(QDebug d, const TLSavedContact &savedContactValue);
QDebug operator<<(QDebug d, const TLSecureCredentialsEncrypted &secureCredentialsEncryptedValue);
QDebug operator<<(QDebug d, const TLSecureData &secureDataValue);
QDebug operator<<(QDebug d, const TLSecureFile &secureFileValue);
QDebug operator<<(QDebug d, const TLSecurePasswordKdfAlgo &securePasswordKdfAlgoValue);
QDebug operator<<(QDebug d, const TLSecurePlainData &securePlainDataValue);
QDebug operator<<(QDebug d, const TLSecureSecretSettings &secureSecretSettingsValue);
QDebug operator<<(QDebug d, const TLSecureValueType &secureValueTypeValue);
...
QDebug operator<<(QDebug d, const TLStatsURL &statsURLValue);
...
QDebug operator<<(QDebug d, const TLWebAuthorization &webAuthorizationValue);
QDebug operator<<(QDebug d, const TLAccessPointRule &accessPointRuleValue);
...
QDebug operator<<(QDebug d, const TLDialogPeer &dialogPeerValue);
...
QDebug operator<<(QDebug d, const TLHelpDeepLinkInfo &helpDeepLinkInfoValue);
QDebug operator<<(QDebug d, const TLHelpTermsOfService &helpTermsOfServiceValue);
QDebug operator<<(QDebug d, const TLHelpTermsOfServiceUpdate &helpTermsOfServiceUpdateValue);
QDebug operator<<(QDebug d, const TLHelpUserInfo &helpUserInfoValue);
QDebug operator<<(QDebug d, const TLInputChatPhoto &inputChatPhotoValue);
QDebug operator<<(QDebug d, const TLInputDialogPeer &inputDialogPeerValue);
...
QDebug operator<<(QDebug d, const TLInputSecureValue &inputSecureValueValue);
...
QDebug operator<<(QDebug d, const TLPageCaption &pageCaptionValue);
QDebug operator<<(QDebug d, const TLPageTableCell &pageTableCellValue);
QDebug operator<<(QDebug d, const TLPageTableRow &pageTableRowValue);
...
QDebug operator<<(QDebug d, const TLPoll &pollValue);
QDebug operator<<(QDebug d, const TLPollAnswerVoters &pollAnswerVotersValue);
QDebug operator<<(QDebug d, const TLPollResults &pollResultsValue);
QDebug operator<<(QDebug d, const TLReplyMarkup &replyMarkupValue);
QDebug operator<<(QDebug d, const TLSecureRequiredType &secureRequiredTypeValue);
QDebug operator<<(QDebug d, const TLSecureValue &secureValueValue);
QDebug operator<<(QDebug d, const TLSecureValueError &secureValueErrorValue);
QDebug operator<<(QDebug d, const TLSecureValueHash &secureValueHashValue);
...
QDebug operator<<(QDebug d, const TLAccountAuthorizationForm &accountAuthorizationFormValue);
...
QDebug operator<<(QDebug d, const TLAccountWebAuthorizations &accountWebAuthorizationsValue);
...
QDebug operator<<(QDebug d, const TLHelpProxyData &helpProxyDataValue);
...
QDebug operator<<(QDebug d, const TLInputSingleMedia &inputSingleMediaValue);
...
QDebug operator<<(QDebug d, const TLMessagesFoundStickerSets &messagesFoundStickerSetsValue);
